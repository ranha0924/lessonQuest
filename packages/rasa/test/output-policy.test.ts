...
describe('validateHintOutput', () => {
  ...
  it.each([
    ...
    { ...valid, content: 'Οption B is correct.' },
    { ...valid, content: 'Chоose B.' },
    { ...valid, content: 'Ѕelect B.' },
    { ...valid, content: 'Рick choice C.' },
    { ...valid, content: 'h\u200Bttps://evil.example' },
    { ...valid, content: 'http\u200Bs://evil.example' },
